...
def import_page(apps, schema_editor):
    ...
    if Page.objects.filter(url="contact").exists():
        Page.objects.get(url="contact").delete()

    import_page_from_json_file('website/page-data/contact.json')


class Migration(migrations.Migration):

    dependencies = [
        ('website', '0012_about_page'),
    ]
